 ...
 export default function MerchantPage() {
  ...
  return (
    <div className="min-h-screen bg-[#ECE4B7] flex items-center justify-center p-4">
      {/* Main Card Container (keeps merchant colors) */}
      <div className="w-full p-5 max-w-7xl rounded-[90px] border-4 border-[#694873] overflow-hidden flex flex-col lg:flex-row bg-[#694873]">
        ...
        {/* Left Panel - Image (keeps merchant image) */}
        <div className="w-full lg:w-5/7.2 relative overflow-hidden">
          <img
            src="/png/Screen Printing vs Heat Press_ Which One is Better on T-Shirts_.jpeg"
            alt="Merchant working on shirt"
            ...
            <form onSubmit={handleLogin} className="space-y-6 w-full max-w-md mx-auto">
              ...
              <div className="space-y-6 w-full max-w-md mx-auto">
                ...
                <p className="text-center text-sm">
                  ...
                  <a href="/" className="text-[#ECE4B7] font-semibold hover:underline">
                    {t('form.signupLink')}
                  </a>
                </p>
              </div>
